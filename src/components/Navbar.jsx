function Navbar({ toggleMenu, openMenu }) {
    ...
    <nav className="navbar p-4 justify-between relative h-[10vh] md:px-6">
      <div className="flex justify-between w-full">
        ...
        <div className="desktop-nav hidden md:flex">
          <ul className="nav-items transition duration-300 flex gap-7 items-center">
            ...
            <li className="nav-item">
              <a
                className="btn text-black bg-white capitalize text-lg font-normal w-full hover:bg-black hover:text-white hover:shadow-2xl"
                href="#"
              >
                Request a quote
              </a>
  ...
  function MobileMenu() {
    let open = openMenu ? "translate-x-0" : "translate-x-[-100%]";
    return (
      <>
        <div
        ...
        >
          <ul className="nav-items transition duration-300 flex flex-col gap-7 w-full h-full">
            <div className="close cursor-pointer w-full" onClick={toggleMenu}>
              <img src="./images/bx-x.svg" alt="" className="ml-auto" />
            </div>
            <li className="nav-item">
              <a href="#" className="text-lg">
                About us
